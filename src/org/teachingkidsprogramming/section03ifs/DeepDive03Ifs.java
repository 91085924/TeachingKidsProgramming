...
public class DeepDive03Ifs
{
  ...
  //test for ChooseYourOwnAdventure
  //our very first test
  @Test
  ...
  public void cyoaWakeUpTest2() throws Exception
  {
    String result = MessageBox.askForTextInput("Do you want to 'wake up' or 'explore' the dream?");
    //test that user enters "explore"
  ...
  @Test
  public void ifPlusTaxStatement() throws Exception
  {
    String totalCost = "$1.25";
    if (_____)
    {
      totalCost = "$0.99";
    }
    Assert.assertEquals("$1.25", totalCost);
  }
  /**
